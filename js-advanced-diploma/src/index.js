...
const { readData, writeData, response, makeAccount, pregenerateMineCurrencies, premakeAccounts, formatAmount, generateAccountId, pregenerateHistory } = require("./utils.js");
...
const KNOWN_OTHER_ACCOUNTS = Object.freeze(["61253747452820828268825011", "05168707632801844723808510", "17307867273606026235887604", "27120208050464008002528428", "2222400070000005", "5555341244441115"]);

const KNOWN_CURRENCY_CODES = Object.freeze(["ETH", "BTC", "USD", "EUR", "JPY", "GBP", "AUD", "CAD", "CHF", "CNH", "HKD", "NZD", "RUB", "UAH", "BYR"]);
